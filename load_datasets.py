...
class DatasetDownloader:
    ...
    def finance_datasets(self):
        ...
        recommended_datasets = [
            # Stock and Finance Sentiment Datasets
            'zach741/stocktwits_sentiment',
            # 'financial_phrase_bank',
            # 'hollandjg/stock_sentiment',
            'rahulrk81/stock-sentiment-twitter',
            
            # Additional potential datasets
            # 'tweets_sentiment_emotion',
    ...
    def bulk_download(self, datasets=None):
        ...
        """
        if datasets is None:
            datasets = self.finance_datasets()
...
def main():
    ...
    recommended = downloader.finance_datasets()
